...
Basado en la solución presentada por \cite{houle2020} se implementó un puerto a \texttt{C++}  usando paralización de memoria compartida con \texttt{OpenMP}, los gráficos que se presentan a continuación fueron generados mediante \texttt{Gnuplot}, el cuál también se uso para filtrar los datos obtenidos del código.  A continuación presentaré los resultados obtenidos
